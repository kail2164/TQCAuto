...
public class InitResources {
	...
	public static Map<String,File>  initImageMap() {
		...
		map.put("LoaderNo", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\LoaderNo.png"));
		map.put("LoaderServer", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\LoaderServer.png"));
		map.put("GameAccept", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\GameAccept.png"));
		map.put("GameTamQuocServer", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\GameTamQuocServer.png"));
		map.put("GameSelectSub", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\GameSelectSub.png"));
		map.put("CharAccept", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\CharAccept.png"));
		map.put("AutoStart", new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\AutoStart.png"));
		return map;
	}
	
	public static List<File>  initListNumber() {
		List<File> list = new ArrayList<>();
		list.add(new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\numbers\\0.png"));
		list.add(new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\numbers\\1.png"));
		list.add(new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\numbers\\2.png"));
		list.add(new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\numbers\\3.png"));
		list.add(new File("D:\\Code\\TQCAuto\\src\\main\\java\\img\\numbers\\4.png"));
